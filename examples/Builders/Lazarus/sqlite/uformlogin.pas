...
begin
  ...
  try
    ControlBuilder
      ...
      .Add(TControlBuilder.Create(TLabel).WithCaption('Nome de usuário'))
      .Add(TControlBuilder.Create(TEdit, 'EditUserName', FEditUserName).WithText('').WithWidth(250))
      .Add(TControlBuilder.Create(TLabel).WithCaption('Senha'))
      .Add(TControlBuilder.Create(TEdit, 'EditPassword', FEditPassword).WithText('').WithWidth(250).Setup(@SetupEditPassword))
      .SetDirection(cpdHorizontal)
      .IncTop(20)
      .Add(TControlBuilder.Create(TBitBtn, 'ButtonOk').WithWidth(75).Setup(@SetupButtons))
      .Add(TControlBuilder.Create(TBitBtn, 'ButtonCancel').WithWidth(75).Setup(@SetupButtons))
